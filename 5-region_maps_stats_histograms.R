#--------------------------------------------------------------------------
# Ag Observatory R Tutorial: Maps, Histograms and Statistics 
#
# Purpose of script:
...
# This script requires you to load a supporting functions file that typically
# found in Github or saved in the Source folder in the recommended folder
# structure. This step loads additional functions required to create the maps.
# Copy the path name and paste it over the phrase, "YOUR PATHNAME".
...
# Load WEATHER data file(s). These may be provided to you during trainings but
# you can also download them through the apps.awhere.com in the "Maps4ER" tab,
# "GET DATA HERE". This can be any number of files, individual files will be
# looped over.

# CHANGE THIS to be your path to a weather file
weather_file_list <- c("YOUR PATHFILE HERE/200209_past7.csv", 
                       "YOUR PATHFILE HERE/200209_past30.csv", 
                       "YOUR PATHFILE HERE/200209_next7.csv",
                       "YOUR PATHFILE HERE/200209_next8to15.csv",
                       "YOUR PATHFILE HERE/200209_next15.csv") 
...
# soil type, and other data sets for each unique aWhere grid cell. 
...
# available attribute. 
#
# subarea_select <- c("ENTIRE_REGION"
#                    ,"admin0_name: Kenya"
...
for (j in 1:length(weather_file_list))  {    
  ...
  for (x in 1:length(subarea_select)) {
    ...
    max_temp_LTN_title <- paste0("Current Max Temperature vs LTN\n"
                            ,subarea_select_name,"\n"
                            ,tools::file_path_sans_ext(weather_name))
