#--------------------------------------------------------------------------
# Ag Observatory R Tutorial: Forecast summary table 
#
# Purpose of script: 
...
# Prior to running this script, we encourage you to find the latitude and 
...
# (up to 7-day, 168 hours) for your location of interest and a table of the 
...
# Install the aWhere API package, if you have not already
...
# CHANGE THIS to the path and name of your locations file
...
for (i in(1:nrow(locations))) { 
  ...
  forecast<- aWhereAPI::forecasts_latlng(lat
                                        ...
                                        ,block_size = 6)  
  # MUST use 6 hours and up to 7 days (Sys.Date()+7) so table formatting below
  # applies.
