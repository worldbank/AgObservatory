#--------------------------------------------------------------------------
# Ag Observatory R Tutorial: Create Climatology Chart
#
# Purpose of script: 
...
# location(s) of interest. The locations file must have 3 columns called 
...
# 
#The outputs of this script include a chart for each location you added in your
#locations file as well as a corresponding output csv for further analysis (this
#is the raw data). The charts can be embedded in reports or visuals for quick
#interpretation.
#
...
# In this section, we will pull the entire dataset for your location of interest. 
...
date_start <- "2018-10-01"  # CHANGE TO THE STARTING DATE OF YOUR CHOICE 
date_end <- day_end <- as.character(Sys.Date() + 14)  # CHANGE TO THE ENDING DATE OF YOUR CHOICE 
...
for (i in 1:nrow(locations)) {
  ...
  chart_title <- paste0("Weekly Climate Chart for ", place_name, 
   ...
   weekly_chart <- generateaWhereChart(data = weather_df,
                                       ...
                                       yAxisLimits = c(0, 125), # fix y axis
                                       # helpful to compare data between
                                       # different locations
